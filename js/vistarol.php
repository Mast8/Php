...
<html lang="en">
	...
	<body>
		<div class="container">
          ...
          if( password_verify($contra, $hash) and $row['ID_ROL']== 3) { 
            header('Location: auxiliar/dashboard.php'); }
          else 
              if( password_verify($contra, $hash) and $row['ID_ROL']== 2) { 
                header('Location: docente/dashboard.php'); }
              else  if (password_verify($contra, $hash) and $row['ID_ROL']==1 ){
                        header('Location: administrador/dashboard.php');
                     } else {

                          echo "<div class='alert alert-danger mt-4' role='alert'>Correo o contraseña incorrecta! <p><a href='login.php'><strong>Intente de nuevo</strong></a></p></div>"; 
       					    }	
